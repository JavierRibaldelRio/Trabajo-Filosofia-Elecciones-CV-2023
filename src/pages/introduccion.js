...
function Introduccion() {
    ...
    return <>
        <div className="container-fluid">
            <div className="row">
                <div id="introduccion" className="col-md-6">
                    <h1>Introducción</h1>
